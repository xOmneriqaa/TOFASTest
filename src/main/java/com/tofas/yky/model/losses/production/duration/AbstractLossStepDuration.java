...
@MappedSuperclass
public class AbstractLossStepDuration {

    @Id
    @SequenceGenerator(name = "SEQ_YKY_LOSSES_STEP_DURATIONS", sequenceName = "SEQ_YKY_LOSSES_STEP_DURATIONS", allocationSize = 1)
    @GeneratedValue(generator = "SEQ_YKY_LOSSES_STEP_DURATIONS", strategy = GenerationType.SEQUENCE)
    protected Long id;
    ...
    public BigDecimal getTotalCost() {
        return this.stepDurationCached.multiply(BigDecimal.valueOf(qty))
