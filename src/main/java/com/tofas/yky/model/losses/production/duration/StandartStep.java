...
@Entity
@Table(schema = "TFS_YKY", name = "YKY_STD_STEPS")
public class StandartStep extends TfEntity {

    @Id
    @SequenceGenerator(name="SEQ_YKY_STD_STEPS", sequenceName="SEQ_YKY_STD_STEPS", allocationSize = 1)
    @GeneratedValue(generator="SEQ_YKY_STD_STEPS", strategy = GenerationType.SEQUENCE)
    private Long id;
    ...
    @CollectionTable(name = "YKY_STD_STEP_PROD_LOSS_SUB_TYP", schema = "TFS_YKY",
        joinColumns = @JoinColumn(name = "STD_STEP_ID"))
    ...
    public boolean equals(Object o) {
        ...
        StandartStep that = (StandartStep) o;
